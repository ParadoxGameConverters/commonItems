...
class LocalizationBlock
{
  public:
	...
	//  });
	void ModifyForEveryLanguage(const LocalizationBlock& other_block, const Localization::LocalizationLambda& modifying_function);
	void ModifyForEveryLanguage(const LocalizationBlock& other_block, const Localization::TwoArgLocalizationLambda& modifying_function);
