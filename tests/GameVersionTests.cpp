...
TEST(GameVersion_Tests, extractVersionFromBranchTxtReturnsNullortForMissingFile)
{
...
TEST(GameVersion_Tests, extractVersionFromBranchTxtReturnsNullortForBrokenFile)
{
...
TEST(GameVersion_Tests, extractVersionFromBranchTxtReturnsNullortForIncompleteFile)
{
...
TEST(GameVersion_Tests, extractVersionFromBranchTxtReturnsNullortForNonsenseFile)
{
